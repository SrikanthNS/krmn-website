    ...
    <>
      ...
      <section className="bg-primary pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          >
            <p className="text-white/40 text-xs tracking-editorial uppercase mb-4 font-sans">
              Join Us
            </p>
            ...
            <p className="text-white/50 text-base font-sans font-light leading-relaxed max-w-xl">
              ...
              commitment to excellence, integrity, and meaningful client work.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <Reveal>
            ...
            <p className="text-slate-400 text-xs tracking-editorial uppercase mb-3 font-sans">
              Why KRMN
            </p>
            <h2 className="font-display font-normal text-primary text-4xl md:text-5xl leading-tight mb-16 max-w-xl">
              More than a workplace.
              <br />
              <em className="italic font-normal text-slate-500">
                A place to grow.
              </em>
            </h2>
          </Reveal>
            ...
            {culturePoints.map(({ icon: Icon, title, desc }, i) => (
              <Reveal key={title} delay={i * 0.06}>
                <div className="bg-white p-8 md:p-10 group hover:bg-surface transition-colors duration-200 h-full">
                  ...
                  <h3 className="font-sans font-semibold text-primary text-base mb-3">
                    {title}
                  </h3>
            ...
            <Reveal delay={0.1} className="lg:col-span-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-border">
                {perks.map((perk) => (
                  <div
                    key={perk}
                    className="bg-white px-6 py-5 flex items-center gap-3"
                  >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <Reveal>
            <div className="border border-border p-12 md:p-16 text-center">
              ...
              <h3 className="font-display font-normal text-primary text-2xl mb-3">
                No open positions right now.
              </h3>
              <p className="text-slate-500 text-sm font-sans leading-relaxed max-w-md mx-auto mb-8">
                We don't have any specific openings at the moment, but we're
                always interested in hearing from talented professionals. Submit
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <Reveal className="lg:col-span-4">
              <div className="sticky top-32">
                <div className="w-8 h-px bg-slate-300 mb-6" />
                <p className="text-slate-400 text-xs tracking-editorial uppercase mb-8 font-sans">
                  General Application
                </p>
                <p className="text-slate-600 text-sm font-sans leading-relaxed mb-6">
                  Interested in joining KRMN & Associates? Send us your resume
                  and a brief note about yourself. We'll keep your details on
                  file and reach out when a suitable opportunity arises.
                </p>
                <p className="text-slate-400 text-xs font-sans leading-relaxed">
                  Your information is treated with the same confidentiality we
              ...
              {submitted ? (
                <div className="border border-border bg-white p-12 text-center">
                  ...
                  <p className="text-slate-500 text-sm font-sans leading-relaxed max-w-sm mx-auto">
                    ...
                    and will review it carefully. We'll be in touch if there's a
                ...
                <form onSubmit={handleSubmit} className="space-y-0">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-border">
                    ...
                    <div className="bg-white p-0">
                      <label className="block">
                        <span className="block text-[10px] text-slate-400 uppercase tracking-editorial font-sans px-5 pt-5 pb-1">
                          Full Name *
                        </span>
                        <input
                          type="text"
                  ...
                  <div className="bg-white border-t border-border p-0">
                    <div className="px-5 pt-5 pb-1">
                      <span className="block text-[10px] text-slate-400 uppercase tracking-editorial font-sans">
                        Resume / CV (PDF)
                      </span>
                    </div>
                  ...
                  <div className="pt-4">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="inline-flex items-center gap-2 bg-primary text-white text-sm font-sans font-medium px-8 py-4 hover:bg-secondary transition-colors disabled:opacity-50"
                    >
                      {loading ? "Submitting…" : "Submit Application"}
                      {!loading && <ArrowUpRight size={15} />}
                    </button>
                    <p className="text-slate-400 text-xs font-sans mt-4">
                      All applications are reviewed personally by the partners.
            ...
            {[
              ...
              <Reveal key={step} delay={i * 0.06}>
                <div className="bg-white p-10">
                  <p className="font-mono text-[10px] text-slate-300 mb-5">
                    {step}
                  </p>
                  <h3 className="font-sans font-semibold text-primary text-base mb-3">
                    {title}
