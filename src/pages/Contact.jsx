    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          >
            ...
            <p className="text-white/50 text-base font-sans font-light leading-relaxed max-w-lg">
              Share your situation and we'll follow up to schedule a
              ...
              <div className="sticky top-32">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="text-slate-400 text-[10px] tracking-editorial uppercase font-sans mb-1">
                        Email
                      </p>
                      <a
                        href="mailto:info@krmn.in"
                        className="text-primary text-sm font-sans hover:text-accent transition-colors"
                      >
                        info@krmn.in
                      </a>
                    </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="tel:+918041307010"
                        className="text-primary text-sm font-sans hover:text-accent transition-colors block"
                      >
                        +91 80 4130 7010
                      </a>
                      <a
                ...
                <div className="mt-10 pt-8 border-t border-border">
                  <p className="text-slate-400 text-[10px] tracking-editorial uppercase font-sans mb-2">
                    Registration
                  </p>
                  <p className="text-slate-500 text-xs font-sans">
                    ICAI Firm Registration No. 013727S
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.1} className="lg:col-span-8">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-0">
                  ...
                  <div className="pt-4">
                    {error && (
                      <p className="text-red-600 text-sm font-sans mb-3">
                        {error}
                      </p>
                    )}
                    <button
                      type="submit"
                      disabled={loading}
                      className="inline-flex items-center gap-2 bg-primary text-white text-sm font-sans font-medium px-8 py-4 hover:bg-secondary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
      ...
      <section className="py-24 bg-surface border-t border-border">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <Reveal>
            <div className="w-8 h-px bg-slate-300 mb-6" />
            <p className="text-slate-400 text-xs tracking-editorial uppercase mb-12 font-sans">
              What to expect
            </p>
          </Reveal>
            ...
            {[
              ...
              <Reveal key={step}>
                <div className="bg-white p-10">
                  ...
                  <h3 className="font-sans font-semibold text-primary text-sm mb-3">
                    {title}
                  </h3>
